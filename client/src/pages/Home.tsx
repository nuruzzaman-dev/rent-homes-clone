  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (mobileMotion && lifestyleRef.current && lifestyleTrackRef.current) {
        ...
        gsap.set(cards, { autoAlpha: 0.28, y: 34, scale: 0.985 });
        cards.forEach((card) => {
          gsap.to(card, {
            autoAlpha: 1,
            y: 0,
